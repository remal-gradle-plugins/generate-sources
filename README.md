...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.1<!--/property--> to <!--property:gradle-api.max-version-->9.7.0-rc-1<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.generate-sources' version '2.0.6'
}
```
<!--/plugin-usage-->
