...
**Tested on Gradle versions from <!--property:gradle-api.min-version-->7.1<!--/property--> to <!--property:gradle-api.max-version-->9.2.0-rc-2<!--/property-->.**
...
```groovy
plugins {
    id 'name.remal.generate-sources' version '2.0.2'
}
```
<!--/plugin-usage-->
